...
class AttractionScraper(Scraper):
    def __init__(self,  db_conn = None, place_id = 186338, base_url="https://www.tripadvisor.com/Attractions-g{}-Activities-{}-a_allAttractions.true", search_type="attractions"):
    ...
    def scrape_page(self, url):
        ...
        for div in divs:
            ...
            attraction.url = div.find("div", {"class" : "_2pZeTjmb"}).find("a").get("href")
    ...
    def update_attraction(self, attr):
        ...
        querystring = self.db_cur.mogrify(query_template, (attr.ID, attr.name, attr.url, attr.attr_type))
